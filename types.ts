...
export type BackgroundStyle =
  | 'studio_plain'
  | 'studio_vibrant_color'
  | 'outdoor_natural_park'
  | 'outdoor_urban_street'
  | 'indoor_cozy_cafe'
  | 'indoor_modern_loft'
  | 'simple_standing_pose'
  | 'simple_sitting_pose'
  | 'simple_action_shot'
  | 'flat_lay_minimalist_wood'
  | 'flat_lay_styled_concrete'
  | 'flat_lay_fabric_texture';
