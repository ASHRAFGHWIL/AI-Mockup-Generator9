...
export const MODEL_POSES: {id: ModelPose, nameKey: string}[] = [
    ...
    { id: 'professional_urban_rooftop', nameKey: 'modelPose_professional_urban_rooftop' },
    { id: 'creative_art_gallery', nameKey: 'modelPose_creative_art_gallery' },
    { id: 'professional_modern_office', nameKey: 'modelPose_professional_modern_office' },
    { id: 'creative_neon_city_night', nameKey: 'modelPose_creative_neon_city_night' },
    { id: 'natural_forest_path', nameKey: 'modelPose_natural_forest_path' },
    { id: 'urban_graffiti_wall', nameKey: 'modelPose_urban_graffiti_wall' },
    { id: 'cozy_bookstore', nameKey: 'modelPose_cozy_bookstore' },
    { id: 'beach_golden_hour', nameKey: 'modelPose_beach_golden_hour' },
